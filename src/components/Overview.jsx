  ...
  return (
    <div>
      <div class="overview-container">
        <h1 class="overview-title"> Why choose us </h1>
        <div class="overview-item overview-1">
        ...
        <div class="overview-item overview-2">
          <div class="overview-content oc-2">
            <h2>Suspendisse faucibus interdum posuere lorem</h2>
            <p>
        ...
        <div class="overview-item overview-3">
          <div class="overview-pics">
            <img
              src={overview3}
              alt="overview-img"
          ...
          <div class="overview-content">
            <h2>Morbi leo urna molestie at elementum eu facilisis sed.</h2>
            <p>
